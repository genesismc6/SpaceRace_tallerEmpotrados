                ...
                for(j = 0; j <= 14; j++){
                        ...
                        for(i = 0; i < 2; i++){
                                if((debris[j].y >= ship[i].y) && (debris[j].y <= ship[i].y + 6) && (debris[j].x >= ship[i].x) && (debris[j].x <= ship[i].x + 6)){
                                        ...
                                        Glcd_H_Line(ship[i].x-2,ship[i].x+6,ship[i].y+7,0);
                                        Glcd_H_Line(ship[i].x-2,ship[i].x+6,ship[i].y,0);
                                        Glcd_H_Line(ship[i].x-2,ship[i].x+6,ship[i].y-1,0);
                                        if(i == 0){
                                                ship[i].x = 40;
                                                ship[i].y = 60;
                                        }
...
void move_ia(){
        ...
        //for(q = 0; q <= 5; q++){
        if(turn2 == 1){
                 erase_player(ship[1].x, ship[1].y, 1);
                 move_player(1,1);
                 draw_player(ship[1].x, ship[1].y, 1);
                //ship[1].y += 2;
                //cont += 1;
                                ...
                                if((debris[j].x >= areaX) && (debris[j].x <= ship[1].x + 10)){
                                        if((debris[j].y >= areaY) && (debris[j].y <= ship[1].y + 6)){
                                                if(debris[j].y <= centerShip){
                                                        ...
                                                        erase_player(ship[1].x, ship[1].y, 2);
                                                        move_player(1,2);
                                                        draw_player(ship[1].x, ship[1].y, 1);
                                                        ...
                                                        //mover hacia abajo
                                                        //ship[1].y -= 2;
                                                        //Glcd_H_Line(ship[1].x-2,ship[1].x+6,ship[1].y+6,0);
